...
<head>
    <meta charset="utf-8">
    <title>AWB <?= esc($awb) ?> — Ninja Xpress</title>
...
<div class="label">
    <section class="header">
        <strong style="font-size:18px">NINJA XPRESS</strong>
        <strong style="font-size:14px"><?= esc($status === 'cnc' ? 'CLICK & COLLECT' : 'STANDARD') ?></strong>
    </section>
